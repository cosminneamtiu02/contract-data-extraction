...
- Phase 0.5 CI/CD design + accepted deviations log: [docs/superpowers/specs/2026-05-11-ci-cd-scaffolding-design.md](docs/superpowers/specs/2026-05-11-ci-cd-scaffolding-design.md) (§17 latest: §17.36 — cycle-1 of fresh 3-cycle standalone review on `chore/panel-review-fixes-2026-05-13-pass2` (sonnet), 5 applied fix-commits across plan.md / codeql.yml / dependabot-automerge.yml / ci.yml / pyproject.toml; 2 false-positive lens findings caught at synthesizer pre-apply)
