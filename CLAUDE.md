...
- Phase 0.5 CI/CD design + accepted deviations log: [docs/superpowers/specs/2026-05-11-ci-cd-scaffolding-design.md](docs/superpowers/specs/2026-05-11-ci-cd-scaffolding-design.md) (§17 latest: §17.33 — cycle-4 of fresh 8-cycle loop on `chore/panel-review-fixes-2026-05-13` (sonnet), 4 applied fix-commits)
