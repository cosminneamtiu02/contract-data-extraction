...
# fixture-consumer) so it cannot use the fixture even if it wanted to.
# ``_resolve_samples_dir`` is now the canonical resolution helper for both
# `pytest_generate_tests` and any future fixture/test that needs the directory.
